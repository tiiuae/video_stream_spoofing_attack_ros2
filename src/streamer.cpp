...
public:
    ...
    bus_(nullptr), cnt_(0)
  {
    ...
    this->declare_parameter("firmware_version", rclcpp::ParameterValue(5.2));
    firmware_version_ = this->get_parameter("firmware_version").as_double();
    // killCameraNode();
